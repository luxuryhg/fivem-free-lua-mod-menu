...
developers = {
" - sususu#4444", -- Out of respect for this free release, please leave my name somewhere in here.
"BRUTAN - Brutan#3927", -- Helped across the board, also made the infamous theme and misc WarMenu adjustments (for themes/controls)
"obama - obama#6666" -- Made weather functions and provided some nice links to obj/ped dbs
}

menuName = "BRUTAN"		-- The name of the menu
version = "9.2"				-- Keep it simple
